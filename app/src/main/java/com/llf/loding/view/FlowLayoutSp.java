...
public class FlowLayoutSp extends ViewGroup {
    public FlowLayoutSp(Context context) {
        super(context);
    }

    public FlowLayoutSp(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FlowLayoutSp(Context context, AttributeSet attrs, int defStyleAttr) {
...
/**
 * 只有在内容为wrap情况下才需要记录width和height
 * width：总宽度
 * height：总高度
 * lineWidth:行宽
 * lineHeight ：行高
